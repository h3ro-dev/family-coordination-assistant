...
const sourceDocs = [
  ...
  },
  {
    ...
    questions: [
      ...
      "Which items were covered in the meeting?",
      "How should the roadmap, tranches, ownership terms, and follow-up commitments be updated?",
      "How should the next-Friday follow-up be represented in the project system?"
    ],
    summary:
      "Adds a plain-language May 21 meeting synthesis with the items covered, roadmap/project updates, deterministic tranche one, voice tranche two, camp automation tranche three, company-owned IP, founder decision control, May 29 decision checkpoint, and follow-up package."
  },
  {
    file: "TRACKER.md",
...
const promptRuns = [
  ...
  },
  {
    ...
    prompt: "Otter transcript synthesis into readable roadmap and follow-up package",
    model: "Codex GPT-5 with Otter.ai transcript review, Product Manager skill, and proposal-readability-editor",
    status: "Updated in local workspace; tracked in GitHub issue #21",
    question:
      "Review the May 21 Tamara meeting, identify what changed, list the items covered, update the roadmap/proposal/research appendix, improve readability for a broad business audience, and add the next-Friday follow-up meeting to the project system."
  }
];
